...
import { units } from "./weather.js";



export default function updateUI(data, selectors) {
  ...
  selectors.weatherMinMax.innerHTML = `<p>Min: ${data.main.temp_min.toFixed()}&#176</p> <p>Max: ${data.main.temp_max.toFixed()}&#176</p>`;  selectors.weatherRealfeel.innerHTML = `${data.main.feels_like.toFixed()}&#176`;
  selectors.weatherHumidity.innerHTML = `${data.main.humidity}%`;
  selectors.weatherWind.innerHTML = `${data.wind.speed} ${units === "imperial" ? "mph" : "m/s"}`;
